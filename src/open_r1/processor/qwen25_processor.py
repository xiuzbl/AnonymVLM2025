...
class Qwen2_5_VLProcProcessor(ProcessorMixin):
    r"""
    ...
    def __call__(
        ...
        input_image_grid_thw: Optional[torch.Tensor] = None,
        **kwargs: Unpack[Qwen2_5_VLProcessorKwargs],
        ...
        elif input_image_grid_thw is not None:
            # use the pre-defined image grid thw for text processing
