...
JOB_RUN_NAME="Adaptive-v2-Qwen25VL-3B-SFT-vocot-orsta7b-distilled-1epochs_lr5e-6"
...
export MODEL_SAVE_PATH=${MODEL_BASE_PATH}/checkpoints/sft/vocot_orsrta_distilled/${MODEL_NAME}_adaptive_vocot-orsta7b-distilled-1epochs_lr5e-6

# ========= Data Path Settings ========= #
export DATA_CONFIG="config/datasets/sft/sft_grd-vocot_txt-orsta-7b-distilled.yaml"
