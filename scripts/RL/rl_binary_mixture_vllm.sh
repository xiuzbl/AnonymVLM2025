...
export MODEL_NAME="Qwen2.5-VL-3B-Instruct" # change to Qwen2.5-VL-7B-Instruct for 7B experiments
JOB_NAME="RL-Phase1-Adaptive-v2-${MODEL_NAME}-SFT-vocot-mc-orsta7b-distilled-1epochs_lr5e-6-AdaGRPO-binary-mix-max2048"

# ========= Model Path Settings ========= #
export MODEL_LOAD_PATH=${MODEL_BASE_PATH}/checkpoints/sft/vocot_orsrta_distilled/${MODEL_NAME}_adaptive_vocot-orsta7b-distilled-1epochs_lr5e-6 # path to the SFT checkpoint
